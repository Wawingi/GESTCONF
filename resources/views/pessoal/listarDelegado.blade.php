                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Listar Delegados</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Listagem de Delegados</h4>
                </div>
            </div>
        </div>
        <br>        
                    ...
                    <table id="paginationFullNumbers" class="table table-bordered" cellspacing="0" width="100%">
                            <thead id="cabecatabela">
                                <tr>
                                    ...
                                    <th>Nome</th>
                                    <th>Sexo</th>
                                    <th>Cartão de Militante</th>
                                    <th>Cap</th>
                                    <th>Tempo de Militância</th>
                                    <th width="15%"></th>
                                </tr>
                            </thead>
                            <tbody id="dataTable">
